...
class _LoginState extends State<Login> {
  ...
  GlobalKey<FormState>? _formKey; // Make _formKey nullable
      ...
      try {
        ...
        SchedulerBinding.instance.addPostFrameCallback((_) {
          Navigator.push(context,
              ...
              // MaterialPageRoute(builder: (BuildContext context) => face1()));
        });
      } catch (e) {
        setState(() {
          visible = load(visible);
  ...
  Future<void> googleSignIn(BuildContext context) async {
    try {
      ...
      if (googleUser != null) {
        ...
        displayToastMessage('Google Sign In canceled', context);
      }
    } catch (e) {
      setState(() {
        gvisible = load(gvisible);
